...
export default function HallOfShamePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <p className="text-gray-400 text-center mb-8">Today's top roasts — resets at midnight MSK</p>
      ...
      {submissions.length === 0 ? (
        <div className="text-center text-gray-500 mt-16">
          ...
          <p className="text-gray-500 mb-4">
            Today's leaderboard is empty. Come back after midnight MSK for a fresh start!
          </p>
